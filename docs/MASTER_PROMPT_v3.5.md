...
3. Выбор дня отгрузки (transit = число дней В ПУТИ от своего дня отгрузки):
   **Оба варианта уже годны (в окне + до дедлайна) ⇒ оба безопасны для еды. Внутри окна лишний день
   в пути еду НЕ портит, поэтому выбор экономический.**
   - нет bestToday, есть bestMonday                                  → понедельник
   - transitMonday < transitToday  И  priceMonday ≤ priceToday + $3  → понедельник  (быстрее, в пределах $3)
   - priceMonday < priceToday × 0.85                                 → понедельник  (>15% дешевле — даже если на день дольше в пути)
   - иначе                                                           → сегодня
...
> **Почему так (Владимир 2026-06-12):**
> - Случай «быстрее за копейки» (заказ `112-5404197`): сегодня FedEx Home $32.91 / 3 дня vs понедельник
>   FedEx 2Day $32.85 / 2 дня → понедельник дешевле И быстрее → берём понедельник.
> - Случай «большая экономия» (заказ `112-8268143`, CRITICAL, окно 2 дня): сегодня из пятницы в окно 2 дня
>   лезет ТОЛЬКО UPS Next Day Air Saturday **$82.73** (1 день в пути); понедельник FedEx 2Day **$17.78**
>   (2 дня в пути — ровно в окне) → берём понедельник, экономия 79%. Платить $82 за Next Day, когда есть
>   годный $17, — абсурд (Владимир). Лишний день в пути внутри окна еду не портит.
> - **15%-порог** — чтобы не дёргать отгрузку на понедельник ради копеечной экономии при том же сроке.
> `MONDAY_SHIFT_MIN_SAVING_PCT = 0.15`, `FROZEN_SPEED_TOLERANCE_USD = 3`.
...
Для каждого Frozen Amazon-заказа (любой день):
  ...
  elif priceMonday < priceToday*0.85                                 → ship Monday   // >15% дешевле (оба в окне)
