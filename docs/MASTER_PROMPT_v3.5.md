...
> **Почему так (Владимир 2026-06-12):** если понедельник **меньше дней в пути** (= меньше риск
> разморозки для frozen) и при этом **не дороже более чем на $3** — берём понедельник, даже если экономия
