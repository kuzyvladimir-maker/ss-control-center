# 🧠 Product Resolution & Retail Sourcing Engine — общий мозг Product Truth Platform

> **Исторический технический замысел, обновлён каноном 2026-07-18.** Главный
> контракт: [[product-catalog-architecture]]. Текущий план и gates:
> [[donor-catalog-execution-roadmap]]. При конфликте этот файл уступает канону.
> Связан с
> [COGS / True-Cost Agent](cogs-true-cost-agent.md),
> [Procurement Module](procurement-module.md), [Bundle Factory](bundle-factory.md).

## 🎯 Главный инсайт: четыре потребителя — один движок

Четыре бизнес-направления опираются на один и тот же товарный фундамент:
...
| **C. Bundle Factory / Listing Creation** | создавать новые листинги | взять подтвержденные данные/фото/описание → собрать listing draft |
| **D. Listing Improvement** | исправлять существующие листинги | сравнить listing с точным вариантом → создать remediation draft |
...
➡️ **Вывод: строим этот движок ОДИН раз, а четыре направления — его потребители.**
