...
- **[Product Truth Owner Gates](product-truth-owner-gates.md) — единый живой decision ledger: независимые G1–G8, точные разрешённые/запрещённые действия, approval phrases и consumed evidence без конкурирующих prompts.**
...
- **[Walmart New SKU — item price vs customer shipping](walmart-new-sku-shipping-price-strategy.md) — channel-specific коммерческая политика Walmart US для seller-fulfilled новых SKU (evidence review + owner decision 2026-07-26): как делить итоговую сумму между ценой товара и доставкой; Product Truth не меняет.**
- **[Walmart New SKU — item price vs customer shipping](walmart-new-sku-shipping-price-strategy.md) — evidence-based политика free/paid shipping: landed price, Buy Box/Listing Quality, buyer psychology, формула template split и controlled experiment.**
