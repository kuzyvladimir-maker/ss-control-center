...
- [Walmart Maruchan FaisalX-1433–1435 — exact repair contract](walmart-maruchan-faisalx-1433-1435-repair.md) — owner-approved three-SKU correction: full gallery proves Roast Chicken Flavor 24/60/120 cups and wrong Chicken MAIN mixing; exact replacement images, title/description/bullets/attributes, weight lower bounds, pricing formula and frozen live-write blockers.
