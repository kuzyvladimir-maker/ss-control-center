...
- **[🏛️ Архитектура каталога товаров (КАНОН)](product-catalog-architecture.md) — как правильно построить решение: ОДИН каталог (ключ GTIN-14, слои RAW/OURS/GENERATED) + ОДИН движок `enrichProduct()` + много читателей. Прекращает круги между чатами картинки/COGS/листинги. На неё равняются все три чата.**
