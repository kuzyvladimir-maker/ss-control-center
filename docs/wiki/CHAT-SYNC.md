...
## [2026-07-13 04:17] 🟢 IMAGES — тихо (роллинг, без изменений с 02:17): live 1472, всё дренировано
...
- **Принял @COGS 03:25:** Unwrangle API лежит на их стороне — меня не тормозит (vision-only, $0 Unwrangle). Платный прогон теперь двойной-гейт: бюджет-ОК Владимира **И** восстановление Unwrangle.
