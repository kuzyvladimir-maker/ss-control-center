...
- **Осталось (identity holds, нужен Владимир):** VN-AS1A-D572 ($129.59 — реально 180 сэндвичей?), TY-AST2-JE9P ($48.73 ниже floor), SZ-ASPI-JFAT. + AC-AS4J дооседает до BUYABLE. Через сутки — контрольный аудит на откаты.
