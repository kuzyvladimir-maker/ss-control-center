...
>
> **Последнее обновление:** 2026-06-21 (поздний вечер) — весь день строили **Financial Plan**
> (`/finance`). Всё на проде. Остановились на **авто-захвате чеков из почты** — протестировали
> end-to-end, работает. См. блок «🆕 СЕССИЯ 2026-06-21» сразу ниже.
