...
- [Алгоритм выбора ставки](shipping-rate-selection.md) — где actualShipDay используется как ship-day
- [Frozen Shipping Rules](frozen-shipping-rules.md) — правило Frozen ≤3 cal.day транзита
