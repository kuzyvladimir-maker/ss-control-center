...
## 🔗 Связи
- **Используется в:** [Customer Hub](customer-hub.md), [Account Health](account-health.md), [A-to-Z & Chargeback](atoz-chargeback.md), [Feedback Manager](feedback-manager.md), [Adjustments Monitor](adjustments-monitor.md), [Amazon Notifications Map](amazon-notifications-map.md) (SP-API Reports/Notifications как альтернативный канал получения уведомлений)
