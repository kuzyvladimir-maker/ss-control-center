...
**Осталось:** перечинка всех 82 браков (идёт волнами через очередь) → потом 237 троттлинг +
757 «нет фото» (теперь с фолбэком); ручной рычаг генерации в UI; DonorProduct write-through +
vision-identify; Walmart-KB в контент Growth (Шаг 4).
