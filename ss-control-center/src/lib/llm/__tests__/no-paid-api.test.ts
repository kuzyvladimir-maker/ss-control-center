...
const ALLOWED = new Set([
  ...
  "lib/customer-hub/atoz-analyzer.ts",
  "lib/customer-hub/feedback-analyzer.ts",
  "lib/customer-hub/message-analyzer.ts",
  "lib/customer-hub/translator.ts",
  "lib/finance/receipt-ocr.ts",
  "lib/sourcing/donor-catalog.ts",
  "lib/sourcing/vision.ts",
  "lib/walmart/multipack/analyst.ts",
  "lib/walmart/multipack/polish.ts",
