  ...
  try {
    ...
    const expense = await prisma.recurringExpense.create({
      data: {
        ...
        frequency: ["monthly", "weekly", "one_time"].includes(b.frequency) ? b.frequency : "monthly",
...
export async function PATCH(req: NextRequest) {
  try {
    ...
    if (b.frequency && ["monthly", "weekly", "one_time"].includes(b.frequency)) data.frequency = b.frequency;
