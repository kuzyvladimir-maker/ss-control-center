...
| `docs/MASTER_PROMPT_v3.5.md` | Shipping Labels — Frozen-логика (2 условия + $3 + 15% Monday) + новый Rate Shopping API | **Актуальный** (v3.1-v3.4 как history) |
| `docs/wiki/veeqo-rate-shopping-api.md` | Настоящий левер даты: POST /shipping/api/v1/rates + preferred_shipment_date | **Актуальный** |
